		...
		<el-card>
			...
			<el-row class="cat_opt">
				<el-col>
					<span>选择商品分类：</span>
					<!-- 选择商品分类的级联选择框 -->
					<el-cascader v-model="selectedCateKeys" :props="cateProps" expand-trigger="hover" :options="catelist" @change="handleChange"></el-cascader>
				</el-col>
			</el-row>
			<!-- tab 页签区域 -->
